		...
		foreach($p1Ships as $ship)
		{
			if ($ship->getPc() > 0)
			{
                ...
                if($ship->getActivated() == false && $player == 1)
                    echo '<a href="http://rush01.local.42.fr:8080/j08_php/ex00/main.php?id=' . $ship->getName() . '&joueur=1">';
		...
		foreach($p2Ships as $ship2)
		{
			if ($ship2->getPc() > 0)
			{
                ...
                if($ship2->getActivated() == false && $player == 2)
                    echo '<a href="http://rush01.local.42.fr:8080/j08_php/ex00/main.php?id=' . $ship2->getName() . '&joueur=2">';
